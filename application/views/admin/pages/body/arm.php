<div id="content">
                <div class="tabs-wrapper text-center">             
                        ...
                        <div class="panel-body" style="padding-bottom:0px;">
                            <div class="col-md-12">
                                ...
                                <p class="animated fadeInDown">
                                    Body Building <span class="fa-angle-right fa"></span> <?= $work_name ?> Workout
                                </p>
                            </div>
                    ...
                    <div class="col-md-12 tab-content">
                                    ...
                                    <div class="tabs-wrapper text-center">    
                                        <button type="button" class="btn btn-info btn-round btn-add-workout-week"  data-workoutid="<?= $workout_id?>" >Add Workout </button>
