        ...
        <div class="col-md-12 padding-0">
            <div class="col-md-12 padding-0">
                ...
                <div class="col-md-12 top-20 padding-0">
                    <div class="col-md-12">
                        <div class="panel">
                            <div class="panel-heading"><h3>Inactive Trainers</h3></div>
                            <div class="panel-body">
                                    ...
                                    <table id="datatables-example" class="table table-striped table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <?php
                                                if($users){
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <th colspan="6" class="text-sm-center text-md-center text-lg-center text-xl-center">There are no inactive trainers</th>
                                                        </tr>
                                                    <?php
