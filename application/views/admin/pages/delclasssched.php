        ...
        <div class="col-md-12 padding-0">
            <div class="col-md-12 padding-0">
                ...
                <div class="col-md-12 top-20 padding-0">
                    <div class="col-md-12">
                        <div class="panel">
                            <div class="panel-heading"><h3>Deleted Class Schedule</h3></div>
                            <div class="panel-body">
                                                    ...
                                                    foreach($sched as $s):
                                                        ...
                                                        ?>
                                                            ...
                                                            <td><?= $s->class_name ?></td>
                                                                ...
                                                                <td> <span class="label label-raised label-<?= $s->status == 1 ? 'success' : 'danger' ?>"><?= $s->status == 1 ? 'Deleted' : 'Not Deleted' ?></span></td>                                                             
                                                                <td><button
                                                                    type="button" class="btn btn-<?= $s->remove_status == 1 ? 'warning' : 'info'?> btn-sm delete_status"
                                                                    data-id="<?= $s->id?>" data-status="<?= $s->remove_status ?>"
                                                                    ><i class="fa fa-edit"></i> <?= $s->remove_status == 1 ? 'Undelete' : 'Delete' ?>
                                                                 </button>
                                                                 </td>
                                                            </tr>
                                                        <?php
